...
import 'package:crypto/component/News/newsHeaderModel.dart';
import 'package:crypto/component/News/newsListBottom.dart';
import 'package:crypto/screen/news/news_header_slider/intro_page_item.dart';
import 'package:crypto/screen/news/news_header_slider/page_transformer.dart';
import 'package:crypto/screen/news/news_list_detail/news_list_detail.dart';
...
Widget card(newsListBottom item, BuildContext context) {
  return Padding(
    padding: const EdgeInsets.only(left: 25.0, top: 15.0, bottom: 0.0),
    child: InkWell(
      onTap: () {
