...
import 'package:crypto/Library/intro_views_flutter-2.4.0/lib/Models/page_button_view_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        elevation: 0.0, backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      ),
      onPressed: onTap,
      child: Opacity(
        opacity: opacity,
